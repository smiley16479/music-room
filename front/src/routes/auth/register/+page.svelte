  ...
  <div class="w-full max-w-md space-y-8 p-8 bg-white dark:bg-gray-800 rounded-lg shadow-md">
    <div class="text-center">
      ...
      <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
        Join {config.appName} and start your musical journey
      </p>
    </div>
    ...
    <form class="mt-8 space-y-6" on:submit={handleSubmit}>
      <div class="space-y-4 rounded-md">
        <div>
          <label for="display-name" class="sr-only">Username</label>
          <input
            id="display-name"
            name="displayName"
            type="text"
      ...
      <div class="flex items-center">
        ...
        <label for="terms" class="ml-2 block text-sm text-gray-900 dark:text-gray-300">
          I agree to the 
          <a href="/terms" class="font-medium text-primary hover:text-primary-dark">Terms of Service</a>
          and
          <a href="/privacy" class="font-medium text-primary hover:text-primary-dark">Privacy Policy</a>
        </label>
      </div>
