...
/**
 * PlaylistController - API Layer
 * 
 * ARCHITECTURE:
 * This controller provides REST API for playlists through PlaylistService.
 * Playlists are Events with type=LISTENING_SESSION in the database.
 */
@ApiTags('Playlists')
