...
class AppConfig {
  ...
  static const String eventsEndpoint = '/events';  // Unified endpoint for events and playlists
  
  // WebSocket Namespaces
  static const String eventsNamespace = '/events';  // Unified namespace for events and playlists
